...
| **`review_maximum_passes`** | integer ≥ 2 or `uncapped` (optional) | `3` for `thorough` or `maximum`; `uncapped` removes the numeric ceiling while convergence continues; user kickoff may override it |
