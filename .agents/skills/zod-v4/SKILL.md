...
name: zod-v4
description: >
  Zod v4 validation library reference. Auto-loads when working with Zod schemas, validation, z.object,
  z.string, z.infer, safeParse, transforms, discriminatedUnion.
---
