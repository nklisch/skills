...
- Applies to supported plugin skills under `plugins/{agile-workflow,ux-ui-design,nates-toolkit,agentic-research,agent-coordination,background-tasks}/skills/`.
