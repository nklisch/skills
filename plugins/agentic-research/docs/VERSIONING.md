...
|---|---|---|---|
| **Plugin SemVer** | `package.json` + the `.claude-plugin/` and `.codex-plugin/` manifests (lockstep) | *this plugin* changes — a skill, the `research-view` binary, a doc, the vendored surface | **0.2.0** |
