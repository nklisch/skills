...
- Whether the registration schema's field *count* is otherwise correct (the field count at the time of this assessment — nine, before the later ten-field milestone — was the input to this assessment, not its output; other fields were not subjected to derive-vs-store testing here);
