...
- Whether the registration schema's field *count* is otherwise correct (the nine-field count was the input to this assessment, not its output — other fields were not subjected to derive-vs-store testing here);
