...
- Work items are the work record. Keep foundations at durable repository or
  sub-project truth, including the engineering shape contributors need after
  an item closes—never item status, delivery mechanics, qualification
