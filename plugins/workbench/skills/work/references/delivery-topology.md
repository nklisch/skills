...
and applicable [model observations](model-notes.md) with
[delivery's follow-up guidance](../../deliver/SKILL.md#choose-implementation-and-follow-up). These assignments
...
the initial implementer when appropriate; follow
[delivery guidance](../../deliver/SKILL.md#choose-implementation-and-follow-up)
